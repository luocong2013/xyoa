...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveTypeGroup">
	...
	<input name="typegroupcode" class="inputxt" validType="t_s_typegroup,typegroupcode,id" value="${typegroup.typegroupcode }" datatype="s2-50"> <span class="Validform_checktip">请输入2到50个字符</span></div>
	<div class="form">
	<label class="Validform_label"> <t:mutiLang langKey="common.name"/>: </label> 
	<input name="typegroupname" class="inputxt" value="${typegroup.typegroupname }" datatype="s2-50"> <span class="Validform_checktip">请输入2到50个字符</span></div>
	</fieldset>
</t:formvalid>
</body>
</html>
