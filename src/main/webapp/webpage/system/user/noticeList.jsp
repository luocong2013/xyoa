...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="noticeList" fitColumns="true" title="common.notice" actionUrl="noticeController.do?datagrid" idField="id" fit="true" sortName="createTime" sortOrder="desc">
