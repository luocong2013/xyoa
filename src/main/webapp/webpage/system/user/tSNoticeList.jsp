...
<div id="main_depart_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSNoticeList" checkbox="true" fitColumns="true" title="common.notice" actionUrl="noticeController.do?datagrid2" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="授权级别"  field="noticeLevel"  hidden="false"  queryMode="group"  width="100" replace="全员_1,角色授权_2,用户授权_3,部门授权_4"></t:dgCol>
   ...
   <t:dgToolBar title="common.add" icon="icon-add" url="noticeController.do?goAdd" funname="add" width="800" height="500"></t:dgToolBar>
   <t:dgToolBar title="common.edit" icon="icon-edit" url="noticeController.do?goUpdate" funname="update" width="800" height="500"></t:dgToolBar>
   ...
   <t:dgFunOpt exp="noticeLevel#eq#4" funname="queryDept(id)" title="common.authority"></t:dgFunOpt>
...
<div class="easyui-panel" style="padding: 1px;" fit="true" border="false" id="subListpanel"></div>
 ...
 function queryDept(id){
		if(li_east == 0){
			...
			$('#subListpanel').panel("refresh", "tSNoticeDeptController.do?list&noticeId=" + id);
	}
