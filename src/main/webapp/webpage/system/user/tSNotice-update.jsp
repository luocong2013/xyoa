		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
								...
								<script id="content" type="text/plain" style="width:600px;" value='${tSNoticePage.noticeContent}'></script>
						  	 	<script type="text/javascript">
					...
					<tr>
						...
						<td class="value">
         				...
         				&nbsp;&nbsp;<input type="radio" name="noticeLevel" value="4" <c:if test="${tSNoticePage.noticeLevel=='4'}">checked="checked"</c:if> />部门授权						
