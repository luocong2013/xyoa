...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sXyTestController.do?doAdd" tiptype="1" >
					<input id="id" name="id" type="hidden" value="${sXyTestPage.id }">
...
>    
  ...
  <script src = "webpage/xyoa/test/js/sXyTest.js"></script>		
