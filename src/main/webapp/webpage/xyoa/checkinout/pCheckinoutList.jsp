...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="pCheckinoutList"  fitColumns="false" title="" actionUrl="sXyCheckinoutController.do?pCheckDatagrid&userId=${userId}&checkDate=${checkDate}" idField="id" fit="true" queryMode="group">
