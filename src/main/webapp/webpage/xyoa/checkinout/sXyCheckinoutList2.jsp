...
<div id="tempSearchColums" style="display: none;">
  ...
  <t:datagrid name="sXyCheckinoutList2" checkbox="false" fitColumns="false" title="考勤统计表" actionUrl="sXyCheckinoutController.do?datagrid&deptId=${deptid}" 
...
$(document).ready(function(){
	   //给时间控件加上样式
	    $("#sXyCheckinoutList2tb").find("input[name='checkDate_begin']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
	    $("#sXyCheckinoutList2tb").find("input[name='checkDate_end']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
	    $("#sXyCheckinoutList2tb").find("div[name='searchColums']").find("form#sXyCheckinoutList2Form").append($("#tempSearchColums div[name='searchColums']").html());
