...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sXyStaffTrainController.do?doAdd" tiptype="1" >
		...
		<table style="width: 505px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="trainOrganization" name="trainOrganization" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="certificate" name="certificate" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
