...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" beforeSubmit="bSubmit();" action="sXyOutWorkController.do?doAdd" tiptype="1" >
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							   <input id="outStartTime" name="outStartTime" type="text" style="width: 150px"
					...
					<td class="value">
							   <input id="outEndTime" name="outEndTime" type="text" style="width: 150px"
					      						 class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" onchange="timeChange();">
							<span class="Validform_checktip"></span>
				...
				<tr>
					<td align="right">
						...
						<td class="value" colspan="3">
						     	 <input id="applyOutHour" name="applyOutHour" type="text" style="width: 150px" class="inputxt"  readonly="readonly">
