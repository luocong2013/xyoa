...
<div id="tempSearchColums" style="display: none;">
  ...
  <t:datagrid name="sXyCompensateLeaveListHis" checkbox="false" fitColumns="true" title="调休申请历史记录列表" actionUrl="sXyCompensateLeaveController.do?datagridHis" 
 ...
 $(document).ready(function(){
		//给时间控件加上样式
			$("#sXyCompensateLeaveListHistb").find("input[name='leaveStartTime_begin']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyCompensateLeaveListHistb").find("input[name='leaveStartTime_end']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyCompensateLeaveListHistb").find("input[name='leaveEndTime_begin']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyCompensateLeaveListHistb").find("input[name='leaveEndTime_end']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyCompensateLeaveListHistb").find("div[name='searchColums']").find("form#sXyCompensateLeaveListHisForm").append($("#tempSearchColums div[name='searchColums']").html());
