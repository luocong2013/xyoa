...
<div id="tempSearchColums" style="display: none;">
  ...
  <t:datagrid name="sXyCompensateLeaveListCheck" checkbox="false" fitColumns="true" title="享宇调休审批表" actionUrl="sXyCompensateLeaveController.do?datagridCheck" 
   ...
   <t:dgFunOpt funname="goAgreeLeave(id)" title="批准" exp="isApprove#eq#00"></t:dgFunOpt>
   <t:dgFunOpt funname="goNotAgreeLeave(id)" title="否决" exp="isApprove#eq#00"></t:dgFunOpt>
