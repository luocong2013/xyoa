...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" beforeSubmit="bSubmit();" action="sXyBusinessTripController.do?doNotAgreeTrip" tiptype="1" >
