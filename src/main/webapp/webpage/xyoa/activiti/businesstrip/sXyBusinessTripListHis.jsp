...
<div id="tempSearchColums" style="display: none;">
  ...
  <t:datagrid name="sXyBusinessTripListHis" checkbox="false" fitColumns="true" title="出差申请历史记录列表" actionUrl="sXyBusinessTripController.do?datagridHis"
 ...
 $(document).ready(function(){
		//给时间控件加上样式
			$("#sXyBusinessTripListHistb").find("input[name='tripStartTime_begin']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyBusinessTripListHistb").find("input[name='tripStartTime_end']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyBusinessTripListHistb").find("input[name='tripEndTime_begin']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyBusinessTripListHistb").find("input[name='tripEndTime_end']").attr("class","Wdate").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
			$("#sXyBusinessTripListHistb").find("div[name='searchColums']").find("form#sXyBusinessTripListHisForm").append($("#tempSearchColums div[name='searchColums']").html());
