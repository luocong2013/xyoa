...
<body>
	...
	<div class="easyui-tabs" id="stafftabs"
		style="width: 692px; height: auto; margin: auto">
		<div title="个人信息" style="padding: 10px;">
			...
			<t:formvalid formid="formobj" dialog="true" usePlugin="password"
				...
				<table style="width: 680px; margin: auto" cellpadding="0"
					...
					<tr>
						...
						<td class="value"><input id="departname" type="text"
							readonly="readonly" class="inputxt" value="${departname}">
							<input id="deptId" name="deptId" type="hidden"
							value='${staffPage.deptId}'> <a href="#"
                ...
                --> <span class="Validform_checktip"><font
					...
					<tr>
						<td align="right"><label class="Validform_label"> 岗位:
						</label></td>
						<td class="value"><select name="jobNo" id="jobNo">
								<c:forEach items="${deptjobs}" var="list">
									<option value="${list.id}">${list.jobName}</option>
								</c:forEach>
						</select> <span class="Validform_checktip"></span> <label
							class="Validform_label" style="display: none;">岗位</label></td>
						<td align="right"><label class="Validform_label"> <t:mutiLang
									langKey="common.role" />:
						</label></td>
						<td class="value" nowrap><input name="roleid" type="hidden"
							value="${id}" id="roleid"> <input name="roleName"
							class="inputxt" value="${roleName }" id="roleName"
                 ...
                 --%>
					...
					<tr>
						<td align="right"><label class="Validform_label">
								员工编号: </label></td>
						<td class="value"><input id="sttaffId" name="sttaffId"
							disabled="disabled" type="text" style="width: 150px;"
							class="inputxt" value='${staffPage.sttaffId}'><span
					...
					<tr>
						<td align="right"><label class="Validform_label"> 姓名:
						</label></td>
						...
						<td class="value"><t:dictSelect field="sex" type="list"
								typeGroupCode="sex" defaultVal="${staffPage.sex}"
					...
					<tr>
						<td align="right"><label class="Validform_label"> 民族:
						</label></td>
					...
					<tr>
						...
						<td class="value"><input id="checkId" name="checkId"
							value='${staffPage.checkId}' onblur="getcheck()" type="text"
							style="width: 150px" class="inputxt"><input
							id="checkidflag" type="hidden"> <span
							class="Validform_checktip"> <font id="checkIdcheck"
								color="red">*</font></span> <label class="Validform_label"
					...
					<tr>
						...
						<td align="right"><label class="Validform_label"> 专业:
						</label></td>
					...
					<tr>
						...
						<td class="value"><input id="graduationDate"
							...
							<span class="Validform_checktip"><font color="red">*</font></span>
							<label class="Validform_label" style="display: none;">毕业时间</label></td>
					...
					<tr>
						...
						<td align="right"><label class="Validform_label">
								正式转正日期: </label></td>
						<td class="value"><input id="positiveDate"
							name="positiveDate" type="text" style="width: 150px"
							class="Wdate" onClick="WdatePicker()"
							value='<fmt:formatDate value='${staffPage.positiveDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"><font id="stateusercheck"
								color="red">*</font> </span> <label class="Validform_label"
							style="display: none;">正式转正日期</label></td>
					</tr>
					<tr>
						<td align="right"><label class="Validform_label">
								试用期开始时间: </label></td>
						...
						<td align="right"><label class="Validform_label">
								试用期结束时间: </label></td>
						<td class="value"><input id="trialEndData"
							name="trialEndData" type="text" style="width: 150px"
							class="Wdate" onClick="WdatePicker()"
							value='<fmt:formatDate value='${staffPage.trialEndData}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"><font id="statecheck"
								color="red">*</font> </span> <label class="Validform_label"
							style="display: none;">试用期结束时间</label></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="right"><label class="Validform_label">
								可调休天数: </label></td>
						<td class="value"><input id="offWorkCount"
							name="offWorkCount" type="text" style="width: 150px"
							class="inputxt" value='${staffPage.offWorkCount}'> <span
					...
					<tr>
						...
						<td align="right"><label class="Validform_label"> 手机:
						</label></td>
						<td class="value"><input id="mobile" name="mobile"
							type="text" style="width: 150px" class="inputxt"
							value='${staffPage.mobile}'> <span
							class="Validform_checktip"></span> <label class="Validform_label"
					...
					<tr>
						<td align="right"><label class="Validform_label">
								婚姻状况: </label></td>
						<td class="value"><t:dictSelect field="marryState"
								type="list" typeGroupCode="marry_sta"
								defaultVal="${staffPage.marryState}" hasLabel="false"
								title="婚姻状况"></t:dictSelect> <span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">婚姻状况</label></td>
						<td align="right"><label class="Validform_label">
								身份证号码: </label></td>
						<td class="value"><input id="certNo" name="certNo"
							type="text" onblur="getAge();" style="width: 150px"
							class="inputxt" value='${staffPage.certNo}'> <span
					...
					<tr>
						...
						<td class="value"><input id="age" name="age" type="text"
							...
							<label class="Validform_label" style="display: none;">年龄</label></td>
					...
					<tr>
						...
						<td align="right"><label class="Validform_label">
								户籍所在地: </label></td>
						<td class="value"><input id="registerAddr"
							name="registerAddr" type="text" style="width: 150px"
							class="inputxt" value='${staffPage.registerAddr}'> <span
							class="Validform_checktip"></span> <label class="Validform_label"
					...
					<tr>
						...
						<td class="value"><input id="linkmanRelative"
							...
							class="inputxt" value='${staffPage.linkmanRelative}'> <span
							class="Validform_checktip"></span> <label class="Validform_label"
						...
						<td class="value"><input id="siling" name="siling"
							...
							class="inputxt" value='${staffPage.siling}'> <span
							class="Validform_checktip"></span> <label class="Validform_label"
					...
					<tr>
						...
						<td align="right"><label class="Validform_label">
								公积金账号: </label></td>
						<td class="value"><input id="fundNo" name="fundNo"
							type="text" style="width: 150px" class="inputxt"
							value='${staffPage.fundNo}'> <span
							class="Validform_checktip"></span> <label class="Validform_label"
					...
					<tr>
						...
						<td align="right"><label class="Validform_label">
								如果有，犯何罪: </label></td>
						<td class="value"><input id="commit" name="commit"
							type="text" value="${staffPage.commit}" style="width: 150px"
							class="inputxt"> <span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">如果有，犯何罪</label></td>
					...
					<tr>
						...
						<td class="value"><input id="referencename" type="text"
							...
							value='${staffPage.referenceId}'> <input id="referenceId"
							name="referenceId" type="hidden" value='${staffPage.referenceId}'>
 ...
 --> <span class="Validform_checktip"> <font
					...
					<tr>
						...
						<td class="value" colspan='3'><textarea id="remarks"
								...
								style="width: 464px; height: 50px;">${staffPage.remarks}</textarea>
							<span class="Validform_checktip"></span> <label
	 ...
	 -->
			<div>
				...
				<t:dictSelect id="documenttype" field="documenttype" type="list"
					typeGroupCode="documenttype" defaultVal="${doc.documenttype}"
					hasLabel="false" title="上传文件类型"></t:dictSelect>

				&#8195;&#8195;标题: <input name="documentTitle" id="documentTitle"
					type="text" style="width: 140px;">&#8195;&#8195;&#8195; <a
					href="#" class="easyui-linkbutton" iconCls="icon-search"
					onclick="filesSelect()">查询</a>
			</div>
...
<script type="text/javascript">
	...
	function updateObj(id) {
		addurl = "staffEducationController.do?goUpdate&staffId=${staffPage.sttaffId}&id="
				+ id;
	...
	function detailObj(id) {
		gridname = name;
		addurl = "staffEducationController.do?goUpdate&load=detail&staffId=${staffPage.sttaffId}&id="
				+ id;
	...
	function updateExprienceObj(id) {
		addurl = "staffWorkExperienceController.do?goUpdate&staffId=${staffPage.sttaffId}&id="
				+ id;
	...
	function detailExprienceObj(id) {
		gridname = name;
		addurl = "staffWorkExperienceController.do?goUpdate&load=detail&staffId=${staffPage.sttaffId}&id="
				+ id;
	...
	function downObj(id, subclassname) {
		...
		gridname = name;
		url = "commonController.do?viewFile&fileid=" + id + "&subclassname="
				+ subclassname;
		try {
	...
	function filesSelect() {
		...
		GetTable('systemController.do?documentTabList&staffid=${staffPage.id }&typecode=files&field=id,documenttype,documentTitle,createdate,subclassname,&documenttype='
				...
				.datagrid(
						{
							...
							toolbar : [
									'-',
									{
										...
										handler : function() {
											...
											addeducation("添加家庭成员", addurl, 510,
													280);
										}
							...
							onDblClickRow : function(rowIndex, rowData) {
								if (editRow != undefined) {
									$("#home_member_Table").datagrid('endEdit',
											editRow);
								}
				...
				.datagrid(
						{
							...
							toolbar : [
									'-',
									{
										...
										handler : function() {
											...
											addeducation("添加培训经历", addurl, 510,
													200);
										}
							...
							onDblClickRow : function(rowIndex, rowData) {
								if (editRow != undefined) {
									$("#train_Table").datagrid('endEdit',
											editRow);
								}

								if (editRow == undefined) {
									$("#train_Table").datagrid('beginEdit',
											rowIndex);
									editRow = rowIndex;
								}
							},
				...
				.datagrid(
						{
...

							{
								...
								formatter : function(value) {
									return formatepCompanyCount(value);
								}
							}, {
								field : 'position',
								width : 90,
							...
							toolbar : [
									'-',
									{
										...
										handler : function() {
											...
											addeducation("添加工作经历", addurl, 610,
													470);
										}
							...
							onDblClickRow : function(rowIndex, rowData) {
								if (editRow != undefined) {
									$("#exprience_Table").datagrid('endEdit',
											editRow);
								}

								if (editRow == undefined) {
									$("#exprience_Table").datagrid('beginEdit',
											rowIndex);
									editRow = rowIndex;
								}
							},
				...
				.datagrid(
						{
							...
							toolbar : [
									'-',
									{
										...
										handler : function() {
											...
											addeducation("添加教育经历", addurl, 510,
													320);
										}
							...
							onDblClickRow : function(rowIndex, rowData) {
								if (editRow != undefined) {
									$("#education_Table").datagrid('endEdit',
											editRow);
								}

								if (editRow == undefined) {
									$("#education_Table").datagrid('beginEdit',
											rowIndex);
									editRow = rowIndex;
								}
							},
				...
				.datagrid(
						{
							...
							toolbar : [
									'-',
									{
										...
										handler : function() {
											...
											addfilecreatewindow("文件上传", addurl,
													655, 300);
										}
							...
							onDblClickRow : function(rowIndex, rowData) {
								if (editRow != undefined) {
									$("#sheduletime_Table").datagrid('endEdit',
											editRow);
								}
...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				$("#companyId").find("option[value='${staffPage.companyId}']")
						.attr("selected", true);
				$("#jobNo").find("option[value='${staffPage.jobNo}']").attr(
						"selected", true);
				$("#staffSource").find(
						"option[value='${staffPage.staffSource}']").attr(
						"selected", true);
				$("#isCheck").find("option[value='${staffPage.isCheck}']")
						.attr("selected", true);
				$("#state").find("option[value='${staffPage.state}']").attr(
						"selected", true);
				...
				$("#isOutsource").find(
						"option[value='${staffPage.isOutsource}']").attr(
						"selected", true);
