...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sXyStaffHomeMemberController.do?doAdd" tiptype="1" >
		...
		<table style="width: 505px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="relative" name="relative" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="workUnit" name="workUnit" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="workDuty" name="workDuty" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
