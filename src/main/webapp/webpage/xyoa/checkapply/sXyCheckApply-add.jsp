...
<body class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center'" style="padding: 0px; border: 0px; overflow: auto;">
		<t:formvalid formid="formobj" dialog="true" usePlugin="password"
			...
			action="sXyCheckApplyController.do?doAdd" tiptype="1">
			<input id="checkIds" name="checkIds" type="hidden">
			<table style="width: 900px;" cellpadding="0" cellspacing="1"
				class="formtable">
				...
				<tr>
					...
					<td class="value"><input id="tsUser" name="tsUser" type="text"
						...
						value='${tsUserPage.realName}' disabled="disabled"> <span
					...
					<td class="value"><input id="tsDept" name="tsDept" type="text"
						style="width: 150px" class="inputxt"
						value="${tsDepartPage.departname }" disabled="disabled"> <span
						class="Validform_checktip"></span> <label class="Validform_label"
				...
				<tr>
					...
					<td class="value" colspan="3"><t:dictSelect field="checkType"
							...
							hasLabel="false" title="考勤类型"></t:dictSelect> <span
						class="Validform_checktip"></span> <label class="Validform_label"
						style="display: none;">考勤类型</label></td>
				</tr>
				...
				<tr>
					...
					<td class="value" colspan="3"><textarea
							...
							id="remarks" name="remarks"></textarea> <span
						class="Validform_checktip"></span> <label class="Validform_label"
		...
		<t:datagrid name="sXyCheckApplyListAdd" checkbox="true"
			...
			actionUrl="sXyCheckApplyController.do?datagridAdd" idField="id"
			fit="true" queryMode="group" sortName="checkDate" sortOrder="desc" onDblClick="onDbclick_table_row">
