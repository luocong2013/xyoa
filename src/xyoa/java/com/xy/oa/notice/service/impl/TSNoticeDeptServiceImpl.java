package com.xy.oa.notice.service.impl;
...
@Service("tSNoticeDeptService")
@Transactional
public class TSNoticeDeptServiceImpl extends CommonServiceImpl implements TSNoticeDeptServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TSNoticeDeptEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TSNoticeDeptEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TSNoticeDeptEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TSNoticeDeptEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TSNoticeDeptEntity t){
